...
const Footer = () => {
  // ✅ Add status UI so users know it worked
  const [status, setStatus] = useState<"idle" | "sending" | "sent" | "error">(
    "idle"
  );
  const [errorMsg, setErrorMsg] = useState("");

  // ✅ Add this submit handler INSIDE the component (right under state is perfect)
        ...
        <div className="relative mx-auto max-w-[1170px] px-4 pt-17.5 sm:px-8 xl:px-0">
          ...
          <div className="flex flex-col gap-12 lg:flex-row lg:justify-between">
            ...
            <div className="w-full lg:max-w-[520px]">
              ...
              {/* OPTIONAL: clickable email link */}
              <a
                href="mailto:support@josiah-williams.com"
                className="mb-6 inline-block text-white/70 transition hover:text-white"
              >
                support@josiah-williams.com
              </a>
            ...
            <div className="w-full lg:max-w-[600px]">
              ...
              <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
                ...
                <button
                  ...
                  className="button-border-gradient hover:button-gradient-hover relative flex items-center justify-center rounded-lg px-8 py-3.5 text-sm font-medium text-white shadow-button transition hover:shadow-none disabled:opacity-60"
                >
